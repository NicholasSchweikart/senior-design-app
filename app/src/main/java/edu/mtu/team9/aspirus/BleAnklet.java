...
public class BleAnklet extends BluetoothGattCallback{

    public static final UUID CCCD = UUID.fromString("00002902-0000-1000-8000-00805f9b34fb");
    public static final UUID RX_SERVICE_UUID = UUID.fromString("6e400001-b5a3-f393-e0a9-e50e24dcca9e");
    public static final UUID TX_CHAR_UUID = UUID.fromString("6e400003-b5a3-f393-e0a9-e50e24dcca9e");
    public static final UUID UUID_MYSERVICE = UUID.fromString("00771312-1100-0000-0000-ABBA0FA1AFE1");
    public static final UUID UUID_MYCHAR = UUID.fromString("00704204-0077-1210-1342-ABBA0FA1AFE1");
    ...
    public BleAnklet(String device_address, char anklet_id, Context context) {

        this.listener = null;
        this.context = context;
        this.device_address = device_address;
        TAG = "BleAnklet-" + anklet_id;
    ...
    public void readOutChar(){
        BluetoothGattService myservice = bluetoothGatt.getService(UUID_MYSERVICE);
        if(myservice == null){
            Log.d(TAG, "ourservice not found");
            return;
        }

        BluetoothGattCharacteristic mychar = myservice.getCharacteristic(UUID_MYCHAR);
        if(mychar == null){
            Log.d(TAG, "char is null");
            return;
        }

        bluetoothGatt.readCharacteristic(mychar);
    }
    ...
    public void onDescriptorWrite(BluetoothGatt gatt,BluetoothGattDescriptor descriptor, int status){
        ...
        public void onCharacteristicRead(BluetoothGatt gatt, BluetoothGattCharacteristic characteristic, int status) {
            ...
            if (status == BluetoothGatt.GATT_SUCCESS) {
                ...
                Log.d(TAG, "RECIEVED: "+characteristic.getValue());
            }
        }
